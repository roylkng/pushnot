...
var ChromeGCMResponseCountSchema = new mongoose.Schema({
  writeKey: String,
  request_id : String,
  jobType : Number,
...
}, {collection: 'jobs_chromegcmresponsecount'});

var chromeGCMResponseCountModel = dbConnection.model('ChromeGCMResponseCount', ChromeGCMResponseCountSchema);
var model = module.exports = chromeGCMResponseCountModel;
